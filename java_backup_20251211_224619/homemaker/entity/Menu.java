...
public class Menu {
    ...
    public boolean equals(Object o) {
        ...
        return !(this$primaryPhoto == null ? other$primaryPhoto != null : !((Object)this$primaryPhoto).equals(other$primaryPhoto));
    }
    ...
    public String toString() {
        return "Menu(id=" + this.getId() + ", homemakerId=" + this.getHomemakerId() + ", status=" + String.valueOf((Object)this.getStatus()) + ", publishedDate=" + String.valueOf(this.getPublishedDate()) + ", validFrom=" + String.valueOf(this.getValidFrom()) + ", validUntil=" + String.valueOf(this.getValidUntil()) + ", isRecurring=" + this.getIsRecurring() + ", recurrencePattern=" + this.getRecurrencePattern() + ", cuisineTypes=" + String.valueOf(this.getCuisineTypes()) + ", description=" + this.getDescription() + ", estimatedPrepTime=" + this.getEstimatedPrepTime() + ", menuType=" + String.valueOf((Object)this.getMenuType()) + ", minOrderQuantity=" + this.getMinOrderQuantity() + ", maxOrderQuantity=" + this.getMaxOrderQuantity() + ", averageRating=" + this.getAverageRating() + ", totalOrders=" + this.getTotalOrders() + ", totalReviews=" + this.getTotalReviews() + ", createdAt=" + String.valueOf(this.getCreatedAt()) + ", updatedAt=" + String.valueOf(this.getUpdatedAt()) + ", items=" + String.valueOf(this.getItems()) + ", photos=" + String.valueOf(this.getPhotos()) + ", primaryPhoto=" + String.valueOf(this.getPrimaryPhoto()) + ")";
    }
