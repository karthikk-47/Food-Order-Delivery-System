...
public class JwtTokenProvider {
    ...
    public String createToken(Authentication authentication) {
        ...
        return Jwts.builder().setSubject(authentication.getName()).claim(AUTHORITIES_KEY, (Object)authorities).signWith(this.key, SignatureAlgorithm.HS256).setExpiration(validity).compact();
    }
