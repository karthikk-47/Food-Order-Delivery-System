...
public class HomemakerProfile {
    ...
    protected void onCreate() {
        ...
        this.totalOrders = 0;
        this.totalRatings = 0;
        this.currentMonthCancellations = 0;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof HomemakerProfile)) {
            return false;
        }
        HomemakerProfile other = (HomemakerProfile)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof HomemakerProfile;
    }
