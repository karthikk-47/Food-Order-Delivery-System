...
@Entity
@Table(name="homemaker_analytics")
public class HomemakerAnalytics {
    @Id
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof HomemakerAnalytics)) {
            return false;
        }
        HomemakerAnalytics other = (HomemakerAnalytics)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof HomemakerAnalytics;
    }
