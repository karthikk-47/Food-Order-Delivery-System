...
public class UserProfile {
    ...
    protected void onCreate() {
        ...
        this.totalOrders = 0;
        this.totalFavouriteHomemakers = 0;
        this.totalSpent = 0.0;
    }
    ...
    @Generated
    public UserProfile(Long id, Long userId, String firstName, String lastName, String email, String phoneNumber, String profileImage, String primaryAddress, String city, String state, String zipCode, Double latitude, Double longitude, Boolean hasAddressSaved, Integer addressCount, AccountStatus accountStatus, Boolean emailVerified, Boolean phoneVerified, LocalDateTime emailVerifiedAt, LocalDateTime phoneVerifiedAt, String preferredPaymentMethod, Boolean notificationsEnabled, Boolean promotionalEmailsEnabled, Integer totalOrders, Integer totalFavouriteHomemakers, Double totalSpent, Double averageOrderValue, LocalDateTime createdAt, LocalDateTime updatedAt, LocalDateTime lastLogin) {
        this.id = id;
        this.userId = userId;
        this.firstName = firstName;
        this.lastName = lastName;
