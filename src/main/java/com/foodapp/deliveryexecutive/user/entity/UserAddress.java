...
public class UserAddress {
    ...
    public String toString() {
        return "UserAddress(id=" + this.getId() + ", userId=" + this.getUserId() + ", addressLabel=" + this.getAddressLabel() + ", street=" + this.getStreet() + ", city=" + this.getCity() + ", state=" + this.getState() + ", zipCode=" + this.getZipCode() + ", phoneNumber=" + this.getPhoneNumber() + ", latitude=" + this.getLatitude() + ", longitude=" + this.getLongitude() + ", isDefault=" + this.getIsDefault() + ", isActive=" + this.getIsActive() + ", deliveryInstructions=" + this.getDeliveryInstructions() + ", createdAt=" + String.valueOf(this.getCreatedAt()) + ", updatedAt=" + String.valueOf(this.getUpdatedAt()) + ")";
    }
    ...
    @Generated
    public UserAddress(Long id, Long userId, String addressLabel, String street, String city, String state, String zipCode, String phoneNumber, Double latitude, Double longitude, Boolean isDefault, Boolean isActive, String deliveryInstructions, LocalDateTime createdAt, LocalDateTime updatedAt) {
        this.id = id;
        this.userId = userId;
        this.addressLabel = addressLabel;
        this.street = street;
