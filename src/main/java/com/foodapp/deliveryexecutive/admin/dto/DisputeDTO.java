...
public class DisputeDTO {
    ...
    @Generated
    public Dispute.DisputeCategory getCategory() {
    ...
    @Generated
    public Dispute.DisputeResolution getResolution() {
    ...
    @Generated
    public void setCategory(Dispute.DisputeCategory category) {
    ...
    @Generated
    public void setResolution(Dispute.DisputeResolution resolution) {
    ...
    protected boolean canEqual(Object other) {
        return other instanceof DisputeDTO;
    }
    ...
    public int hashCode() {
        ...
        Dispute.DisputeCategory $category = this.getCategory();
        result = result * 59 + ($category == null ? 43 : ((Object)((Object)$category)).hashCode());
        String $description = this.getDescription();
        result = result * 59 + ($description == null ? 43 : $description.hashCode());
        Dispute.DisputeStatus $status = this.getStatus();
        result = result * 59 + ($status == null ? 43 : ((Object)((Object)$status)).hashCode());
        Dispute.DisputeResolution $resolution = this.getResolution();
    ...
    @Generated
    public DisputeDTO(Long id, Long orderId, Long complainantId, Long respondentId, String complainantType, String respondentType, Dispute.DisputeCategory category, String description, Dispute.DisputeStatus status, Dispute.DisputeResolution resolution, Double refundAmount, String resolutionNotes, LocalDateTime createdAt, LocalDateTime updatedAt, LocalDateTime resolvedAt, Long assignedAdminId, LocalDateTime assignedAt, Integer escalationLevel) {
        this.id = id;
        this.orderId = orderId;
        this.complainantId = complainantId;
        this.respondentId = respondentId;
